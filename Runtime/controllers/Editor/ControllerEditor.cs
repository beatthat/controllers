...
namespace BeatThat.Controllers
{
    ...
    public class ControllerEditor : UnityEditor.Editor
    {
        ...
        override public void OnInspectorGUI()
        {
            ...
            var hasPanelTransitions = TypeUtils.Find("BeatThat.Panels.HasPanelTransitions");
        ...
        {
            var iPanelController = TypeUtils.Find("BeatThat.Controllers.Panels.IPanelController");
        ...
        public static void PresentForceLayerOption(UnityEditor.Editor editor)
        {
            ...
            if (view != null)
            { // view and presenter are on the same game object
                return;
            }
